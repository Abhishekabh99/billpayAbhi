                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (_storeAddressController.text.trim().isEmpty ||
                                _storeAddressController.text.trim().length <
                                    3) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                            ...
                            if (_storeAlternateNumberController.text
                                    .trim()
                                    .isNotEmpty &&
                                _storeAlternateNumberController.text
                                        .trim()
                                        .length !=
                                    10) {
                              ScaffoldMessenger.of(context).showSnackBar(
                            ...
                            if (_storeOwnerNameController.text.trim().isEmpty ||
                                _storeOwnerNameController.text.trim().length <
                                    3) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                            ...
                            final (store, result) = await AuthApi.addUser(
                              ...
                              latitude: pickedLocationData?.latLong.latitude
                                      .toString() ??
                                  "",
                              longitude: pickedLocationData?.latLong.longitude
                                      .toString() ??
                                  "",
                              pincode:
                                  pickedLocationData?.addressData["postcode"] ??
                                      "",
                              city:
